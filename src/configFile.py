...
def packingConfigVariables():
    ...
    configParser.set('FILES', 'outputPath', 'C:\ScopusAPIs\output\/autoresAfiliacionTec_'+timeStampStr+'.txt')
    configParser.set('FILES', 'scopublicaciones', 'C:\ScopusAPIs\output\/SCOPUBLICACIONES_'+timeStampStr+'.txt')
    configParser.set('FILES', 'scoafiliaciones', 'C:\ScopusAPIs\output\/SCOAFILIACIONES_'+timeStampStr+'.txt')
    configParser.set('FILES', 'scoautores', 'C:\ScopusAPIs\output\/SCOAUTORES_'+timeStampStr+'.txt')
    configParser.set('FILES', 'scopubbautafil', 'C:\ScopusAPIs\output\/SCOPUBAUTAFIL_'+timeStampStr+'.txt')
    configParser.set('FILES', 'inputPathAuthorsIDs', 'C:\ScopusAPIs\input\inputAuthors.txt')
    configParser.set('FILES', 'inputPathPubsIDs', 'C:\ScopusAPIs\input\inputPubs.txt')
